...
consumedO2 = cellT.*pathO2 + usedO2; % O2 [g] consumed by end of time in each segment
consumedO2 = cumsum(consumedO2); % cumulative O2 [g] consumed by end of time in each segment
generatedCO2 = cellT.*pathCO2 + usedCO2; % CO2 [g] generated by end of time in each segment
