...
consumedO2 = cumsum(consumedO2)+ usedO2; % cumulative O2 [g] consumed by end of time in each segment
generatedCO2 = cellT.*pathCO2; % CO2 [g] generated by end of time in each segment
generatedCO2 = cumsum(generatedCO2)+ usedCO2; % cumulative CO2 [g] generated by end of time in each segment
